          ...
          <div key={statement.id} className="bg-white rounded-md p-4 border border-slate-200">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                >
                  {['YES', 'NO', 'NOT_GIVEN'].map((option) => (
                    <div key={option} className="flex items-center gap-2">
                      <RadioGroupItem 
                        value={option} 
                        id={`${statement.id}-${option}`} 
                        className={cn(
                          option === 'YES' && "text-green-600 border-green-600 focus:ring-green-600",
                          option === 'NO' && "text-red-600 border-red-600 focus:ring-red-600",
                      ...
                      <Label 
                        ...
                        className={cn(
                          ...
                          option === 'YES' && "text-green-600",
                          option === 'NO' && "text-red-600",
